...
Original file is located at
    https://colab.research.google.com/drive/1ukJf4_6QHzvkBteHhgS1BLWsnpXA-B_Q
"""
...
# Example usage
wav_file_path = 'salom.wav'  # Replace with your WAV file path
...
language = 'ru'  # Changed to English ('ru')
